...
class _SearchHotelScreenState extends State<SearchHotelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var selectedCityData = dataHotel
        .firstWhere((city) => city['name'] == selectedCity, orElse: () => {});
    print("Dữ liệu tìm kiếm: ${rangeStart}");
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: Text('$selectedCity , $country',
